...
public class MemberInfoUpdateActivity extends BasicActivity {
        ...
        public void onClick(View v) {
            switch(v.getId()) {
                ...
                case R.id.btn_picture:
                    Log.e("tga","adga");
                    if (ActivityCompat.checkSelfPermission(MemberInfoUpdateActivity.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        goCamera();
                    }else{
                        ActivityCompat.requestPermissions(MemberInfoUpdateActivity.this, new String[]{android.Manifest.permission.CAMERA}, 1);
                    }
                    break;
            }
